...
Функция ЗагрузитьВариантыОтчетовНаСервере()
	...
	Попытка
		...
		Иначе
			МодульВариантыОтчетов.ЗагрузитьПользовательские();
...
Функция НачатьКонвертациюВариантовОтчетов()
	...
	ТаблицаВариантов = ХранилищеОбщихНастроекЗагрузить("ПереносВариантовОтчетов", "ПользовательскиеВарианты", , , "");
