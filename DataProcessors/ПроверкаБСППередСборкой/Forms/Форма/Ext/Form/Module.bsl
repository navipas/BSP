		...
		Если Проверка.ПроводитьПроверку Тогда
			Попытка
				...
				Для Каждого ПромежуточнаяПроверка Из МассивПроверок Цикл
					ИмяПроцедуры = СтрЗаменить(СокрЛП(ПромежуточнаяПроверка), "()", "");
					Свойства = Новый Структура;
					Попытка
						Свойства.Вставить(ИмяПроцедуры);
					Исключение
						ТекстОшибки = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
							НСтр("ru = 'Некорректное имя процедуры модуля ""%1"".'"), ИмяПроцедуры);
						ВызватьИсключение(ТекстОшибки, КатегорияОшибки.ОшибкаКонфигурации);
					КонецПопытки;
					СтруктураОшибок = Вычислить(ИмяПроцедуры + "()"); // Не нарушает безопасность информации, так как вычисляется только функция модуля.
			...
			Исключение
				...
				Если АвтоматическоеТестирование Тогда
					...
					СтруктураОшибки.Вставить("ПредставлениеОшибки", ТекстСообщения);
					СтруктураОшибки.Вставить("ОписаниеИсправления", ПредставлениеОшибки);
					СтруктураОшибки.Вставить("ОшибочныеДанные", Новый СписокЗначений);
					СтруктураОшибки.ОшибочныеДанные.Добавить("Обработка.ПроверкаБСППередСборкой", "Обработка.ПроверкаБСППередСборкой");
					
					СписокВывода.Добавить(СтруктураОшибки);
				Иначе
...
Функция Подключаемый_ПроверитьВхождениеРолейИВидовДоступаВПрофили()
	...
	РолиИсключения.Вставить("ОткрытаяАвторизацияПочтовогоСервисаАнонимныйДоступ", Истина);
...
Функция Подключаемый_ПроверитьСовпадениеМодулейУправляемогоИОбычногоПриложений()
	...
	Текст = ТекстФайлаОбычногоПриложения.ПолучитьТекст();
	ДополнитьТекстОбычногоПриложенияПередСравнением(Текст);
	ТекстФайлаОбычногоПриложения.УстановитьТекст(Текст);
...
Функция ПраваОбъектовМетаданных()
	...
	СписокПрав.Добавить("Чтение"); // @Access-right-1
	СписокПрав.Добавить("Добавление"); // @Access-right-1
	СписокПрав.Добавить("Изменение"); // @Access-right-1
	СписокПрав.Добавить("Удаление"); // @Access-right-1
	СписокПрав.Добавить("Просмотр"); // @Access-right-1
	СписокПрав.Добавить("ИнтерактивноеДобавление"); // @Access-right-1
	СписокПрав.Добавить("Редактирование"); // @Access-right-1
	СписокПрав.Добавить("ИнтерактивноеУдаление"); // @Access-right-1
	СписокПрав.Добавить("ИнтерактивнаяПометкаУдаления"); // @Access-right-1
	СписокПрав.Добавить("ИнтерактивноеСнятиеПометкиУдаления"); // @Access-right-1
	СписокПрав.Добавить("ИнтерактивноеУдалениеПомеченных"); // @Access-right-1
	СписокПрав.Добавить("ВводПоСтроке"); // @Access-right-1
	...
	СписокПрав.Добавить("Изменение"); // @Access-right-1
	СписокПрав.Добавить("Удаление"); // @Access-right-1
	СписокПрав.Добавить("Проведение"); // @Access-right-1
	СписокПрав.Добавить("ОтменаПроведения"); // @Access-right-1
	СписокПрав.Добавить("Просмотр"); // @Access-right-1
	СписокПрав.Добавить("ИнтерактивноеДобавление"); // @Access-right-1
	СписокПрав.Добавить("Редактирование"); // @Access-right-1
	СписокПрав.Добавить("ИнтерактивноеУдаление"); // @Access-right-1
	...
	СписокПрав.Добавить("ИнтерактивноеСнятиеПометкиУдаления"); // @Access-right-1
	СписокПрав.Добавить("ИнтерактивноеУдалениеПомеченных"); // @Access-right-1
	СписокПрав.Добавить("ИнтерактивноеПроведение"); // @Access-right-1
	СписокПрав.Добавить("ИнтерактивноеПроведениеНеОперативное"); // @Access-right-1
	СписокПрав.Добавить("ИнтерактивнаяОтменаПроведения"); // @Access-right-1
	СписокПрав.Добавить("ИнтерактивноеИзменениеПроведенных"); // @Access-right-1
	СписокПрав.Добавить("ВводПоСтроке"); // @Access-right-1
	...
	СписокПрав.Добавить("Просмотр"); // @Access-right-1
	СписокПрав.Добавить("Редактирование"); // @Access-right-1
	СписокПрав.Добавить("УправлениеИтогами"); // @Access-right-1
	...
	СписокПрав.Добавить("ИнтерактивноеУдалениеПомеченных"); // @Access-right-1
	СписокПрав.Добавить("ВводПоСтроке"); // @Access-right-1
	СписокПрав.Добавить("ИнтерактивнаяАктивация"); // @Access-right-1
	СписокПрав.Добавить("Старт"); // @Access-right-1
	СписокПрав.Добавить("ИнтерактивныйСтарт"); // @Access-right-1
	...
	СписокПрав.Добавить("ВводПоСтроке"); // @Access-right-1
	СписокПрав.Добавить("ИнтерактивнаяАктивация"); // @Access-right-1
	СписокПрав.Добавить("Выполнение"); // @Access-right-1
	СписокПрав.Добавить("ИнтерактивноеВыполнение"); // @Access-right-1
...
&НаСервере
Процедура ДополнитьТекстОбычногоПриложенияПередСравнением(Текст)
